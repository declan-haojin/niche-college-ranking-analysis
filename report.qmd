...
To get the data, we scraped from Niche.com and downloaded data from the US Department of Education, and imported.
...
scaled_data|> 
  ...
  labs(
    x = "Admission Rate",
    y = "Rank",
    title = "Rank vs Admission Rate by Control"
  )
...
scaled_data |> 
  ...
  labs(
    ...
    y = "Rank",
    title = "Rank vs Cost of Attendance by Control"
  ) 
...
We have plotted rank vs. several of the numerical variables. This gives us an idea of how the metrics above affect college rank. Just by looking at the graphs, Admission Rate, Mean SAT, Median ACT, Average Faculty Salary, and Graduation Rate seem to have the strongest correlation.
...
We remove the columns that has more than 100 NA and leave the rest for calculating correlations. And here is the correlation matrix for every pair of variables that we are using.
