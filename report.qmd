...
1.  We began our modeling by putting all of our chosen variables into a model
...
These were variables that had a slope with an absolute value less than 10 because that would mean that they have less of an impact on ranking than other variables.

1.  Then, by looking at the slope coefficients of the variables in the model, we determined that the one with the highest slope is the most significant.

```{r}
#| label: ggplot-example-variable-ugds-white
