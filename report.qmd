...
r_squared_values <- tibble(
  ...
  filter(variable != "COSTT4_P" & variable != "ENDOWBEGIN")
...
grid.arrange(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, ncol = 3)
```
...
#| label: r2_slopes_kable


r2_slopes <- r_squared_values |>
  filter(r_squared != 1.000000000) |> 
  arrange(desc(r_squared)) |> 
  slice_head(n = 13) |> 
  mutate(
    scaled_slope = c(-115.0, -112.9, -103.5, -98.89, 91.74, 71.75, -65.21, 63.57, -63.69, -57.38, -56.27, 55.09, 45.71),
    slope = c(-0.9277, -30.04, -735.2, -0.0347, 387.02, 644.76, -1248.5, 643.83, -803.0, -0.002815, -0.002152, 23.05, 615.2)                 
  )
