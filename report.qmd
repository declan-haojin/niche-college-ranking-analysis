...
For our analysis, we joined two datasets using the `left_join()` function.
...
2.  `University of South Florida-Sarasota-Manatee` and `University of South Florida-St. Petersburg` were removed because they did not exist in both datasets. Names of colleges were edited to ensure a successful join.
...
3.  We then joined the two data sets using the `left_join()` function. The resulting data set has 498 observations and 64 variables (although we ultimately chose to only use 32 in our analysis).
...
4.  Many of the categorical variables had their levels listed as numbers, so we edited the dataset to have the the true names of the levels
...
5.  All of the numerical variables are on different scales, so we created scaled version of the numerical explanatory variables, with mean 0 and standard deviation 1.
...
As the rank group gets higher, the mean admission rate increases and the mean SAT Average, ACT Median, and cost of attendance decreases. 1-100 ranked schools have fewer White students and more Asian students than all others. We observed a relationship between the categorical variables and rank, and included that exploratory analysis in the appendix.
...
colleges_levels_acc <- colleges_levels |>
  ...
  mutate(
    ACCREDAGENCY = case_when(
      ACCREDAGENCY == "New England Commission on Higher Education" ~ "New England Commission on\nHigher Education",
      ACCREDAGENCY == "Accrediting Commission of Career Schools and Colleges" ~ "Accrediting Commission of\nCareer Schools and Colleges",
      ACCREDAGENCY == "Northwest Commission on Colleges and Universities" ~ "Northwest Commission on\nColleges and Universities",
      ACCREDAGENCY == "Higher Learning Commission" ~ "Higher Learning Commission",
      ACCREDAGENCY == "Southern Association of Colleges and Schools Commission on Colleges" ~ "Southern Association\nof Colleges and Schools\nCommission on Colleges",
      ACCREDAGENCY == "Middle States Commission on Higher Education" ~ "Middle States Commission on\nHigher Education",
      ACCREDAGENCY == "Western Association of Schools and Colleges Senior Colleges and University Commission" ~ "Western Association of Schools\nand Colleges Senior Colleges\nand University Commission"
  ))
colleges_levels_acc |>
  mutate(
  ACCREDAGENCY = fct_relevel(ACCREDAGENCY,"Accrediting Commission of\nCareer Schools and Colleges", "Northwest Commission on\nColleges and Universities", "Higher Learning Commission", "Southern Association\nof Colleges and Schools\nCommission on Colleges", "Middle States Commission on\nHigher Education", "Western Association of Schools\nand Colleges Senior Colleges\nand University Commission", "New England Commission on\nHigher Education")) |>
...
colleges_levels_cc <- colleges_levels |>
  drop_na(CCBASIC) |>
   filter(
  ...
  mutate(
    CCBASIC = case_when(
    CCBASIC == "Doctoral Universities: Very High Research Activity" ~ "Doctoral Universities: Very\nHigh Research Activity",
    CCBASIC == "Baccalaureate Colleges: Arts & Sciences Focus" ~ "Baccalaureate Colleges: Arts &\nSciences Focus", 
    CCBASIC == "Doctoral Universities: High Research Activity" ~ "Doctoral Universities: High\nResearch Activity",
    CCBASIC == "Master's Colleges & Universities: Small Programs" ~ "Master's Colleges &\nUniversities: Small Programs",
    CCBASIC == "Baccalaureate Colleges: Diverse Fields" ~ "Baccalaureate Colleges:\nDiverse Fields",
    CCBASIC == "Special Focus Four−Year: Engineering Schools", ~ "Special Focus Four−Year:\nEngineering Schools",
    CCBASIC == "Special Focus Four−Year: Faith−Related Institutions" ~ "Special Focus Four−Year:\nFaith−Related Institutions",
    CCBASIC == "Special Focus Four−Year: Arts, Music & Design Schools" ~ "Special Focus Four−Year: Arts,\nMusic & Design Schools",
    CCBASIC == "Doctoral/Professional Universities" ~ "Doctoral/Professional\nUniversities",
    CCBASIC == "Master's Colleges & Universities: Larger Programs" ~ "Master's Colleges &\nUniversities: Larger Programs",
    CCBASIC == "Master's Colleges & Universities: Medium Programs" ~ "Master's Colleges &\nUniversities: Medium Programs",
    CCBASIC == "Special Focus Four−Year: Other Health Professions Schools" ~ "Special Focus Four−Year: Other\nHealth Professions Schools"
  ))
colleges_levels_cc |>
  mutate(
    CCBASIC = fct_relevel(CCBASIC, "Special Focus Four−Year: Other\nHealth Professions Schools", "Master's Colleges &\nUniversities: Medium Programs", "Master's Colleges &\nUniversities: Larger Programs", "Doctoral/Professional\nUniversities", "Special Focus Four−Year: Arts,\nMusic & Design Schools", "Special Focus Four−Year:\nFaith−Related Institutions", "Special Focus Four−Year:\nEngineering Schools", "Baccalaureate Colleges:\nDiverse Fields", "Master's Colleges &\nUniversities: Small Programs", "Doctoral Universities: High\nResearch Activity", "Baccalaureate Colleges: Arts &\nSciences Focus", "Doctoral Universities: Very\nHigh Research Activity")
  ) |>
