...
`COSTT4_P` has an R-squared value of 1 because there are only two observations with entries for it. Therefore, we will not be using it in the stepwise regression model.
