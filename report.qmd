...
As we can see the model's R-squared is around 73.5%.
...
Since the R-squared value is 0.7067 which is even smaller than 0.7354 of our first model, we need to implement forward selection by adding variables back to our model.
