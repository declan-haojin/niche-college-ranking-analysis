...
We have broken down the data into 5 different groups based on the college rank, and then taken the mean of selected variables for each of the groups. This gives us an idea of how different variables change across different types of school.
...
scaled_data |> 
  ...
  geom_point() +
  labs(
    x = "Average Fauculty Salary", 
    y = "Rank",
    title = "Rank vs Average Fauculty Salary"
  ) 
...
We have plotted rank vs. several of the numerical variables. This gives us an idea of how the metrics above affect college rank. Just by looking at the graphs, Admission Rate, Man SAT, Median ACT, Average faculty Salary, and Graduation Rate seem to have the strongest correlation.
