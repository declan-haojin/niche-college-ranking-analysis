...
-   The dataset \`lemur_data.csv\` comes from Kaggle (kaggle.com).
...
-   Why is it important - lemurs are endangered etc etc
...
-   We're going to look at all of the variables bc we don't know which ones will or won't affect lifespan. There are both categorical and quantitative variables involved in our research questions since categorical variables such as taxon and quantitative variables such as weight can all play a role in their lifespan. (include types of categorical and quantitative variables and examples)
